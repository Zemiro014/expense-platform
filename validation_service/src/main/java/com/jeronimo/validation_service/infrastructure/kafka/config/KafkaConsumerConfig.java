...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<String, ReceiptCreatedEvent> receiptCreatedConsumerFactory(
        ...
        JsonDeserializer<ReceiptCreatedEvent> deserializer =
                new JsonDeserializer<>(ReceiptCreatedEvent.class, false);
